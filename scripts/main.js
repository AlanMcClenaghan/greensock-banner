window.onload = function() {
  const timeline = new TimelineMax({ repeat: 3, repeatDelay: 3 });

  timeline.to("#title-container", 0.2, {
    ease: Power1.easeIn,
    opacity: 1,
    scale: 1,
    top: 166
  ...
  timeline.to(
    "#title-container",
    0.5,
    { ease: Power1.easeOut, scale: 0.5, top: 250 },
    "-=0.5"
  );
  timeline.to(
    "#bottom-section",
    0.5,
    { ease: Power1.easeOut, top: 475 },
    "-=0.5"
  );
  ...
  timeline.to("#last-screen", 0.3, { ease: Power1.easeIn, opacity: 1 });

  timeline.to("#upto-txt", 0.3, { ease: Power1.easeIn, opacity: 1 });
  timeline.to("#percent-txt", 0.3, {
    ease: Power1.easeIn,
    opacity: 1,
    scale: 1
  });
